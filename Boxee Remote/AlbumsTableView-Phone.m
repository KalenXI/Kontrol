...
@implementation AlbumsTableView_Phone
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	UITableViewController *targetViewController = [[AlbumTableView_Phone alloc] initWithAlbum:album Name:[currentObject valueForKey:@"strTitle"]];
