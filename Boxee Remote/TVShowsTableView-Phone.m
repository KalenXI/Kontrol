...
@implementation TVShowsTableView_Phone
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	UITableViewController *targetViewController = [[TVShowTableView_Phone alloc] initWithTVShow:tvShow];
